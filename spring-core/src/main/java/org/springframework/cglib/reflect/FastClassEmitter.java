...
class FastClassEmitter extends ClassEmitter {
    ...
    public FastClassEmitter(ClassVisitor v, String className, Class type) {
        ...
        EmitUtils.constructor_switch(e, info, new FastClassEmitter.GetIndexCallback(e, info));
        e.end_method();
    ...
    private void emitIndexByClassArray(List methods) {
        ...
        if(methods.size() > 100) {
            ...
            EmitUtils.method_switch(e, signatures, new FastClassEmitter.GetIndexCallback(e, signatures));
        }

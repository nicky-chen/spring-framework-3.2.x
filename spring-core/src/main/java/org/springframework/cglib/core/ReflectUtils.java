        ...
        AccessController.doPrivileged(new PrivilegedAction() {
            public Object run() {
                try {
                    ...
                    ReflectUtils.DEFINE_CLASS = loader.getDeclaredMethod("defineClass", new Class[]{String.class, byte[].class, Integer.TYPE, Integer.TYPE, ProtectionDomain.class});
                    ReflectUtils.DEFINE_CLASS.setAccessible(true);
                    return null;
                } catch (ClassNotFoundException var2) {
                    throw new CodeGenerationException(var2);
                } catch (NoSuchMethodException var3) {
                    throw new CodeGenerationException(var3);
                }
            }

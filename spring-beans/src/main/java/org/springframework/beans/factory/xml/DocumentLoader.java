...
public interface DocumentLoader {
	 ...
	 * @param entityResolver the resolver that is to be used to resolve any entities 解析文件解析器
	 ...
	 * @param namespaceAware {@code true} if support for XML namespaces is to be provided 命名空间支持。如果要提供对 XML 名称空间的支持，则为true
